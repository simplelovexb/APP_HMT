...
public class HmtForumData implements Serializable {
    ...
    public static class ThreadlistEntity {
         ...
         * comments : 0
         * hidden : 0
         * lastposterenc : %CA%AF%B3%C7%C9%AD%C1%D6
         * multipage :
         * recommendicon :
         * heatlevel : 0
         * moved : 0
         ...
         * weeknew :
         * istoday : 1
         * dbdateline : 1441008672
         * dblastpost : 1441027041
         * id : normalthread_804740
         * rushreply : 0
         */
